...
//		int i1 = 3;
//		int i2 = 4;
//		short result = s1 + s2; !! + 연산 후  자동 int처리됨
//		int result = i1 + i2;
//		----------------------------
//
...
//		----------------------------
//		char c1 = 'a';
//		char c2 = c1 + 1; //이거 앞에 int를 해야되지 않을 까?
...
//		int x = 5;
//		int y = 2;
//		____ result = x/y; 일단 정수만 나올려면 int? 2
...
//		int x = 5;
//		int y = 2;
//		double result = __(double)x/y__________;
//		System.out.println(result);
//		----------------------------
//
...
//		double var1 = 3.5;
//		double var2 = 2.7;
//		int result = _var1 / var2____________;
//		----------------------------
//
